...
tgaImage_t* tga_load(char *filePath)
{
	...
	//9 = indiziert (Farbpalette) laufl�ngenkodiert
	//10 = RGB (24 Bit) laufl�ngenkodiert
	//11 = monochrom laufl�ngenkodiert
	...
	uint8 hdr_colorDepth = stream_readU8(in); //g�ltige Werte sind 1, 8, 15, 16, 24 und 32
